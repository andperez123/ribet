...
COLUMN_ALIASES: dict[str, list[str]] = {
    ...
    "order_date": ["order date", "po date", "date ordered", "created date"],
    "promise_date": [
        "promise date",
        "promised date",
        "due date",
    ...
    "ship_date": ["ship date", "shipping date", "scheduled ship", "ship by"],
    "due_date": ["due date", "required date", "need by", "delivery date"],
    "status": ["status", "line status", "order status", "po status"],
    "open_amount": [
        "open amount",
        "open value",
        "remaining amount",
    ...
    "qty_ordered": ["qty ordered", "quantity ordered", "order qty", "qty", "quantity"],
    "qty_received": ["qty received", "received qty", "quantity received", "qty recv"],
    "qty_open": ["qty open", "open qty", "remaining qty", "backorder qty", "qty remaining"],
}
